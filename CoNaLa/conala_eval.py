...
# import bleu_score     # original code ... but doesn't load
from importlib.machinery import SourceFileLoader
conala = SourceFileLoader("conala.bleu_score", "/Users/nicolasg-chausseau/conala-baseline/eval/bleu_score.py").load_module()
import bleu_score


# Main function for CodaLab evaluation purposes
# def main(): # original code
