...
list_of_code = [tokenize_CODE_FOR_FREQ_ITEMSET(code_snip) for code_snip in dict_of_questions_and_code_TRAIN.values()]

# build vocabulary and train model
model = gensim.models.Word2Vec(
    list_of_SOquestions_stemmed + list_of_code, # to test OLD WAY: change this param to dict_of_SOquestions_stemmed___to___original_SOquestions
...
model.train(
    ...
    #epochs=10,
    epochs=400, # CHANGE!!! epochs=100 increased score by a lot: 15 BLEU, while 1000 brought it down at 13.91 ... 500 seems to not affect results negatively yet.
